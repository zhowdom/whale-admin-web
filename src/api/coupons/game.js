...
const urls = {
  ...
  addGivingCoupon: '/coupon/game/add',                  // 新增赠送优惠券[replace to game]
  ...
  givingPage: '/coupon/game/page',                      // 赠送-优惠券列表[replace to game]
  // givingEnable: '/coupon/giving/update/enable',           // 赠送-启用-停用优惠券
  givingEnable: '/coupon/game/update/enable',           // 赠送-启用-停用优惠券[replace to game]
  // givingDelete: '/coupon/giving/delete',                  // 赠送-删除优惠券
  givingDelete: '/coupon/game/delete',                  // 赠送-删除优惠券[replace to game]
  // givingDetails: '/coupon/giving/details',                // 赠送-优惠券详情（详情页面）
  givingDetails: '/coupon/game/details',                // 赠送-优惠券详情（详情页面）[replace to game]
  // givingEditDetails: '/coupon/giving/get',                // 赠送-优惠券编辑页详情
  givingEditDetails: '/coupon/game/get',                // 赠送-优惠券编辑页详情[replace to game]
  // givingEditUpdate: '/coupon/giving/edit',                // 赠送-优惠券编辑更新
  givingEditUpdate: '/coupon/game/edit',                // 赠送-优惠券编辑更新[replace to game]
