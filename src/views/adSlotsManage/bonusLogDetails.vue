...
<script>
import {adsRent_bonusLogDialog, adsRent_packageList, adsRent_switch} from '@/api/moreCoin/index';
...
export default {
  ...
  methods: {
    ...
    search (pgi) {
      ...
      this.loading = true
      adsRent_bonusLogDialog(_params).then(response => {
        if (response.code === 200) {
