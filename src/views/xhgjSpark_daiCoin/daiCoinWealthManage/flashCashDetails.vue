...
<script>
import { flashCashDetailsPage, exchangeSettingList, daiCoinSettingList } from "@/api/xhgjSpark_api/daiCoinSetting.js";
  ...
  export default {
    ...
    methods: {
      ...
      search (pgi) {
        ...
        this.loading = true
        flashCashDetailsPage(_params).then(response => {
          if (response.code === 200) {
