    ...
    <div class="topshow">
      <el-form :model="queryParams" ref="queryForm" :inline="true" class="mytopformstyle">
        ...
        <el-form-item label="实际到账">
          <el-input clearable v-model="queryParams.intervalMin" placeholder="请输入" style="width:100px;"></el-input>
          <span style="margin:0 10px;">-</span>
          <el-input clearable v-model="queryParams.intervalMax" placeholder="请输入" style="width:100px;"></el-input>
        </el-form-item>
        ...
        <el-form-item label="" style="border:none;">
          <el-button v-hasPermi="['wallet:coin:transaction:recharge:page']" :loading="loading" type="primary" icon="el-icon-search" @click="search(1)">查询</el-button>
