<template>
  <div class="userpower_Wrapper">
        <div class="topshow">
            ...
            <el-form-item label="手机号" prop="memberPhone" style="padding-bottom:20px;">
            ...
            <el-form-item label="" style="border:none;">
                <el-button v-hasPermi="['advertising:treasure_account:page']" :loading="loading" type="primary" icon="el-icon-search" @click="search(1)">查询</el-button>
            </el-form-item>
            </el-form>
        </div>
        <!--table-->
        ...
        style="width: 100%">
            ...
            <el-table-column
                ...
                <el-button v-hasPermi="['advertising:treasure_account_details:page']" type="text" @click="seeClick(scope.row.memberId)">查看</el-button>
              </template>
            </el-table-column>
...
import { atAccountList, atAccountSee, atNameLists, atMarketQuery } from "@/api/adsTreasure";
  export default {
    components: {},
    data () {
