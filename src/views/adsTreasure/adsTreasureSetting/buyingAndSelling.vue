...
<el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="200px" class="demo-ruleForm">
  ...
  <el-form-item label="" prop="day1">
    <div style="margin-top:30px;padding-bottom:30px;">1、购买，收取购买方手续费  <span style="font-size:13px;color:rgb(129, 125, 125);">(购买是指， 用户在【买卖】直接【购买】)</span></div>
    ...
    <p>
       ...
       3. APP 资产列表展示 ：【购买NFT】  【购买NFT手续费】  <br><br>
      </p>
    </div>
  ...
  <el-form-item label="" prop="day2">
    <div style="margin-top:30px;padding-bottom:30px;">2、出售 ， 收取出售方手续费  <span style="font-size:13px;color:rgb(129, 125, 125);">(出售是指， 用户在【买卖】直接【出售】)</span></div>
    <span style="margin-right:10px;">按比例收取手续费</span>
