<template>
  <div class="shareAddManagebox" style="padding:20px;">
    <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="150px" class="demo-ruleForm">
      ...
      <el-form-item label="恶意申诉" prop="unpaid_count1">
      ...
      <el-form-item label="恶意申诉" prop="dj_unpaid_count1">
      ...
      <el-form-item label="恶意申诉" prop="unpaid_count1_ads">
      ...
      <el-form-item label="统计超时未付款时间" prop="dj_tongji_day1_ads">
      ...
      <el-form-item label="超时未付款累计次数" prop="dj_unpaid_count1_ads">
      ...
      <div class="clearfix">
        <el-form-item label="限制天数" prop="day2_ads" class="fl">
