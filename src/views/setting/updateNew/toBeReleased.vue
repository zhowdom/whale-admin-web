...
import {versionPage, versionReleased, listVersions, auditMarket} from '@/api/setting/version';
  ...
  methods: {
    ...
    onAdd () {
      ...
      this.$store.dispatch('tagsView/delView', curView).then(() => {
        this.$nextTick(() => {
          // 跳转页面到新增
          this.$router.replace({path: `toBeReleasedAddNew`});
        })
      });
    },
    // 分页数量修改
