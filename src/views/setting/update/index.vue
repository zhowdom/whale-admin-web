    ...
    <el-row :gutter="20">
      <el-col :span="24">
        <el-tabs class="update-card-tabs" v-model="activeName" type="card">
          <el-tab-pane label="版本管理" name=0 v-hasPermi="['setting:version:page']">
            <update-mgmt v-if="activeName=='0'"/>
          </el-tab-pane>
          <el-tab-pane label="版本待发布" name=1 v-hasPermi="['setting:version:page']">
...
export default {
  ...
  beforeRouteEnter (to, from, next) {
    ...
    const toBeReleased = ['/setting/toBeReleasedAdd', '/setting/toBeReleasedEdit'];
    next(vm => {
