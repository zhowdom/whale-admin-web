<template>
  <div class="shareAddManagebox" style="padding:20px;">
    <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="150px" class="demo-ruleForm">
      ...
      <el-form-item label="取消次数" prop="unpaid_count1">
      ...
      <el-form-item label="取消次数" prop="dj_unpaid_count1">
      ...
      <el-form-item label="取消次数" prop="unpaid_count1_ads">
      ...
      <el-form-item label="取消次数" prop="dj_unpaid_count1_ads">
