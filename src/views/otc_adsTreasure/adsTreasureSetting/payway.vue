        ...
        atQuery({
          ...
          if (+response.code === 200) {
            this.ruleForm = {
              ...
              qijinyong2: response.data.condition ? response.data.condition.wechatPay : false,
              qijinyong3: response.data.condition ? response.data.condition.unionPay : false,
            }
            ...
            atSave(
              {
                condition: {
                  ...
                  unionPay: this.ruleForm.qijinyong3,
                  wechatPay: this.ruleForm.qijinyong2,
                },
