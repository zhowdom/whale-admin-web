          ...
          <el-row :gutter="20">
            <el-col :span="24">
              ...
              <el-form-item label="banner位置" prop="dictCode">
                <el-select class="normal-width" clearable v-model="bannerForm.dictCode" placeholder="请选择banner位置">
              ...
              <el-form-item class="fr mr0">
                <el-button size="small" type="primary" icon="el-icon-search" class="mr15" @click="onSearch" v-hasPermi="['setting:banner:page']">查询</el-button>
                <el-button size="small" type="success" icon="el-icon-plus" @click="handleTabBtn({}, 'Add')" v-hasPermi="['setting:banner:save']">新增</el-button>
              </el-form-item>
            </el-col>
          </el-row>
        </el-form>
    ...
    handleTabBtn(row, type) {
      ...
      this.$store.dispatch('tagsView/delView', curView).then(() => {
        this.$nextTick(() => {
          ...
          this.$router.replace({
            query,
            path: type == 'Add' ? 'addMainBanner' : 'editMainBanner',
          });
        });
      });
    },
