      ...
      <el-col :span="12" :offset="7">
        <div class="form-btns">
          ...
          <template v-if="type=='Add'">
            <el-button type="primary" v-hasPermi="['integral:task:save:product']" @click="submitForm">保存</el-button>
          </template>
          <template v-else>
            <el-button type="primary" v-hasPermi="['integral:task:update:product']" @click="submitForm">保存</el-button>
          </template>
        </div>
      </el-col>
    </el-row>
...
import {saveGlobal, updateGlobal, saveGoods, updateGoods, typeList, activeTypeList, taskInfo} from '@/api/om/task';
