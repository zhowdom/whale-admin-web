<template>
  <div class="all-platforms-ticket-detail">
      ...
      <el-col :span="18">
        <el-form :model="topForm" :rules="rules" ref="topForm" label-width="200px" class="mt100">
          ...
          <!-- <el-form-item label="赠送条件：" prop="giveCondition">
            <el-select class="input-class" clearable v-model="topForm.giveCondition" placeholder="请选择赠送条件" disabled>
              <el-option v-for="(value, key) in giveList" :label="value" :value="key" :key="key"></el-option>
            </el-select>
          </el-form-item> -->
          <el-form-item label="赠送条件：">
            <el-select class="input-class" v-model="topForm.giveCondition" placeholder="请选择赠送条件" disabled>
          ...
          <!-- <el-form-item label="赠送期限：" prop="giveDeadline">
            <el-input class="input-class" v-model.number="topForm.giveDeadline" disabled>
      ...
      <el-col :span="18">
        <el-form :model="mainForm" :rules="rules" ref="mainForm" label-width="200px" class="mt100">
          ...
          <!-- <el-form-item label="触发条件：" prop="receiveCondition">
            <el-select class="input-class" clearable v-model="mainForm.receiveCondition" placeholder="请选择触发条件" disabled>
...
<script>
import {typeList, activeTypeList, taskInfo} from '@/api/om/task';

export default {
  name: 'AllPlatformsTicketDetail',
  data () {
    return {
      topForm: {
        giveCondition: 1,
      ...
      mainForm: {
        ...
        activateDeadline: 90,     // 激活期限
        receiveCondition: 1,     // 限制条件
        taskType: 6,              // 任务类型
      },
      uiForm1: {                  // 任务UI配置-任务商店
        imgUrl: '',               // 背景图片
