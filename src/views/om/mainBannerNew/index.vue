          ...
          <el-row :gutter="20">
            <el-col :span="24">
              ...
              <el-form-item class="fr mr0">
                <el-button :loading="loading" size="small" type="primary" icon="el-icon-search" class="mr15" @click="onSearch" v-hasPermi="['operation:banner:page']">查询</el-button>
                <el-button :loading="loading" size="small" type="success" icon="el-icon-plus" @click="handleTabBtn({}, 'Add')" v-hasPermi="['operation:banner:save']">新增</el-button>
              </el-form-item>
            </el-col>
          </el-row>
        </el-form>
    ...
    handleTabBtn(row, type) {
      ...
      this.$store.dispatch('tagsView/delView', curView).then(() => {
        this.$nextTick(() => {
          ...
          this.$router.replace({
            query,
            path: type == 'Add' ? 'addMainBannerNew' : 'editMainBannerNew',
          });
        });
      });
    },
