    ...
    <div class="top-search">
      <el-form ref="mainForm" inline :model="mainForm" label-width="105px">
        ...
        <el-form-item class="fr mr0">
          <el-button size="small" type="primary" @click="onSearch" v-hasPermi="['coupon:giving:page']">查询</el-button>
          <el-button size="small" type="primary" @click="handleTabBtn(3, {})" v-hasPermi="['coupon:giving:add']">添加优惠券</el-button>
        </el-form-item>
      </el-form>
    </div>
    ...
    <div class="coupons-table">
      <el-table border :data="tableData" @sort-change="sortFunction">
        ...
        <el-table-column prop="releaseTime" align="center" label="禁用情况" width="120">
          <template slot-scope="{row}">
            <el-switch
              ...
              v-hasPermi="['coupon:giving:update_enable']"
            >
            </el-switch>
          </template>
        </el-table-column>
        <el-table-column align="center" label="操作" width="220">
          <template slot-scope="{row}">
            <el-button size="mini" type="warning" v-hasPermi="['coupon:giving:details']" @click="handleTabBtn(1, row)">查看</el-button>
            <el-button size="mini" type="primary" v-if="!row.givingStatus" v-hasPermi="['coupon:giving:edit']" @click="handleTabBtn(2, row)">编辑</el-button>
            <el-button size="mini" type="danger" v-if="!row.givingStatus" v-hasPermi="['coupon:giving:delete']" @click="deleteCiteCoupons(row)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
...
<script>
import {givingPage, givingEnable, givingDelete} from '@/api/coupons/index';
