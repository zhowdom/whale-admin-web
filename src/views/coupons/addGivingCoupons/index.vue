      ...
      <el-form :model="mainForm" :rules="rules" ref="mainForm" label-width="200px" class="mt40">
        ...
        <el-form-item>
          <div class="form-btns">
            ...
            <el-button type="primary" v-hasPermi="['coupon:giving:add']" @click="submitForm">保存</el-button>
...
import {memberSearch, addGivingCoupon} from '@/api/coupons';
...
export default {
  ...
  beforeRouteEnter (to, from, next) {
    ...
    next(vm => {
      if (path == '/promotion/addGivingCoupon') vm.fromList = true;
      return true;
    });
  },
