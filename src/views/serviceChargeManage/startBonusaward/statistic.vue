<template>
  <div class="redBackDetailsBox">
    ...
    <el-form-item label="币种类型">
      ...
      <el-form-item>
        <el-button v-hasPermi="['internal:feeBonus:share:stat:page']" type="primary" :loading="loading" icon="el-icon-search" @click="search(1)">查询</el-button>
      </el-form-item>
    </el-form>
    ...
    <el-table-column
      ...
      <template scope="scope">
        <span>{{scope.row.levelAmounts[0]}}</span>
      </template>
    </el-table-column>
    <el-table-column
      width="159"
      ...
      align="center">
      <template scope="scope">
        <span>{{scope.row.levelAmounts[1]}}</span>
      </template>
    </el-table-column>
    <el-table-column
      width="159"
      ...
      align="center">
      <template scope="scope">
        <span>{{scope.row.levelAmounts[2]}}</span>
      </template>
    </el-table-column>
    <el-table-column
      width="159"
      ...
      align="center">
      <template scope="scope">
        <span>{{scope.row.levelAmounts[3]}}</span>
      </template>
    </el-table-column>
    <el-table-column
      width="159"
      ...
      align="center">
      <template scope="scope">
        <span>{{scope.row.levelAmounts[4]}}</span>
      </template>
    </el-table-column>
    <el-table-column
      width="159"
      ...
      align="center">
      <template scope="scope">
        <span>{{scope.row.levelCounts[0]}}</span>
      </template>
    </el-table-column>
    <el-table-column
      width="159"
      ...
      align="center">
      <template scope="scope">
        <span>{{scope.row.levelCounts[1]}}</span>
      </template>
    </el-table-column>
    <el-table-column
      width="159"
      ...
      align="center">
      <template scope="scope">
        <span>{{scope.row.levelCounts[2]}}</span>
      </template>
    </el-table-column>
    <el-table-column
      width="159"
      ...
      align="center">
      <template scope="scope">
        <span>{{scope.row.levelCounts[3]}}</span>
      </template>
    </el-table-column>
    <el-table-column
      width="159"
      ...
      align="center">
      <template scope="scope">
        <span>{{scope.row.levelCounts[4]}}</span>
      </template>
    </el-table-column>
      ...
      search (pgi) {
        this.$refs['queryForm'].validate((valid) => {
          if (valid) {
            ...
            this.loading = true
            mmStartPoint_profitQuery(_params).then(response => {
              if (response.code === 200) {
