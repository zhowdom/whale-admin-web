<template>
  <div class="redBackDetailsBox">
    ...
    <el-form-item label="币种类型">
      ...
      <el-form-item>
        <el-button v-hasPermi="['internal:platformFee:stat:totalStatPage']" type="primary" :loading="loading" icon="el-icon-search" @click="search(1)">查询</el-button>
      </el-form-item>
    </el-form>
      ...
      search (pgi) {
        this.$refs['queryForm'].validate((valid) => {
          if (valid) {
            ...
            this.loading = true
            mmfee_totalQuery(_params).then(response => {
              if (response.code === 200) {
