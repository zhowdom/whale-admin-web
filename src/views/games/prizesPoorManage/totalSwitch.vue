<template>
  ...
  <el-table :data="nLevelData">
    <el-table-column property="exchangeNo" label="编号"></el-table-column>
    ...
    <el-table-column property="quantity" label="兑换奖码"></el-table-column>
    <el-table-column property="whalePeasUnit" label="奖码单位"></el-table-column>
    <el-table-column property="whalePeas" label="兑换奖码支付Candy"></el-table-column>
...
<script>
import { takejewelCodeList, zzJoyPoorTotalSwitchList } from "@/api/games";
  export default {
    components: {},
    data () {
      ...
      searchnLevel (pgi) {
        this.$refs['nLevelqueryForm'].validate((valid) => {
          if (valid) {
            ...
            this.loading = true
            zzJoyPoorTotalSwitchList(_params).then(response => {
