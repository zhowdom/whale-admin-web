<template>
  <div class="withdraw-container">
    ...
    >
      ...
      <el-table-column prop="amount" label="提现金额" width="109" sortable="custom" align="center"></el-table-column>
      ...
      <el-table-column prop="importBatch" label="导入批次" width="120" align="center"></el-table-column>
      <el-table-column prop="createTime" label="导入时间" width="170" align="center">
        <template slot-scope="{row}">
          {{row.createTime ? $dayjs(row.createTime).format('YYYY-MM-DD HH:mm:ss') : '-'}}
        </template>
      </el-table-column>
      <el-table-column prop="auditTime" label="操作时间" width="170" align="center">
        <template slot-scope="{row}">
      ...
      <el-table-column prop="failCause" width="130" label="转账失败原因" align="center"></el-table-column>
    </el-table>
