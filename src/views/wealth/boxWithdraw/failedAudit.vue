<template>
  <div class="withdraw-container">
    ...
    >
      <el-table-column prop="orderNo" label="订单号" align="center" width="120"></el-table-column>
      ...
      <el-table-column prop="auditTime" label="操作时间" width="180" align="center">
        <template slot-scope="{row}">
          {{row.auditTime ? $dayjs(row.auditTime).format('YYYY-MM-DD HH:mm:ss') : '-'}}
        </template>
      </el-table-column>
      <el-table-column prop="rejectCause" width="130" label="审核失败原因" align="center"></el-table-column>
    </el-table>
